            ...
            <form action="" id="formProduct">
              ...
              <div>
                ...
                <div class="card-footer prod-info">
                  <button type="button" id="add_<?php echo $prodList[$row]["itemCode"]; ?>" class="btn btn-danger cart-action" onClick="manageCart('add','<?php echo $prodList[$row]["itemCode"]; ?>')"><img src="images/add-to-cart.png" > Add to cart</button>
                </div> 
              </div>
            </form>
          </div>
